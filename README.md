...
Sau khi chạy `seed.sql`, database sẽ có:
- 3 Nhân viên (NV1 tự quản lý, NV2 và NV3 do NV1 quản lý)
- 2 Chương trình đào tạo (Web Full-Stack, Data Science)
- 7 Môn học
- 2 Kỳ học (HK1/2024, HK2/2024)
- 2 Khóa đào tạo
- 7 Lớp môn học
- 2 Giảng viên
...
- 3 Học viên
- 3 Đăng ký khóa
- 8 Điểm thi (có cả thi lại)

## Mở rộng

Để hoàn thiện các trang stub còn lại:
1. Copy pattern từ các trang đã có (HocVien, GiangVien, NhanVien, ChuongTrinh, MonHoc, KyHoc)
2. Thay đổi API endpoint, fields, và columns cho phù hợp
3. Thêm foreign key dropdowns nếu cần (như ChuongTrinh, KyHoc, v.v.)

---

**Lưu ý:** Đây là ứng dụng đơn giản cho đồ án sinh viên, ưu tiên chạy được và logic đúng. Chưa có authentication, authorization, hay các tính năng nâng cao khác.
