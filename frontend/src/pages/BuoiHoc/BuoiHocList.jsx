...
export default function BuoiHocList() {
    ...
    const [formData, setFormData] = useState({ ngayhoc: '', giobd: '', giokt: '' });
    ...
    const resetForm = () => {
        setFormData({ ngayhoc: '', giobd: '', giokt: '' });
        setEditingId(null);
        setShowForm(false);
    };
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="time" value={formData.giobd}
                            ...
                            <div>
                                ...
                                <input type="time" value={formData.giokt}
